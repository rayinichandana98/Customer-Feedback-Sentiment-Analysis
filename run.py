...
def index():
    ...
    if request.method=="POST":
        ...
        output = pandas.DataFrame(data={"SentimentText":clean_test_reviews[0:100],"UserName":user_name[0:100],"Polarity":polarity[0:100],"CreationDate":creationdate[0:100],"Image":image[0:100],"Location":location[0:100],"FollowerCount":follower_count[0:100],"FollowingCount":following_count[0:100],
        ...
        with open('Sorted_Entire_Output.csv', 'w') as f:
            fieldnames = ['SentimentText', 'UserName', 'Polarity','CreationDate','Image','Location',"FollowerCount","FollowingCount","Verified","ReTweet","Likes","ID"]
